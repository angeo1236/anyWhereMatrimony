...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
	...
	public boolean performClick() {
		...
		final Button selectAll = view.findViewById(R.id.selectAllButton);
		final Button clearAll = view.findViewById(R.id.clearAllButton);
		final Button submitBtn = view.findViewById(R.id.dialogSubmitButton);
		...
		submitBtn.setOnClickListener(v -> ad.cancel());
